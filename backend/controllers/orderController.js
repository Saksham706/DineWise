...
const placeOrder = async (req, res) => {
    ...
    try {
        ...
        let taxAmount = Math.round(totalAmount * 0.05); // 5% tax rounded to nearest rupee
        ...
        const line_items = req.body.items.map((item) => ({
            price_data: {
                ...
                unit_amount: Math.round(item.price * 100) // Converting to paisa
            },
        ...
        line_items.push({
            price_data: {
                ...
                unit_amount: taxAmount * 100 // Convert to paisa
            },
            quantity: 1
        });
